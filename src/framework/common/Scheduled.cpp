...
void Scheduled::addTask(const ScheduledFunc &fn, const std::chrono::time_point<SystemClock> &tp)
{
    addTask(fn, tp, std::chrono::microseconds::zero());
}

void Scheduled::addTask(const ScheduledFunc &fn, const std::chrono::time_point<SystemClock> &tp, const std::chrono::microseconds &period)
{
